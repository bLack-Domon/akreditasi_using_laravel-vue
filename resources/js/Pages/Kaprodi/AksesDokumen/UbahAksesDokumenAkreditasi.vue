...
const form = useForm({
  id_detail_pengajuan: props.data.id_detail_pengajuan,
...
<template>
  <Head title="Edit Akses Dokumen Akreditasi" />
     ...
     <section class="col-lg-8 mt-3 connectedSortable">
      ...
      >
       ...
       <div class="card card-light">
         ...
         <form class="form-horizontal" @submit.prevent="form.post(`/dokumen-akreditasi/5b1nms38zz${data.id_dokumen}8q0r2y/update_akses`)">
           <div class="card-body">
             <div class="row justify-content-center">
               <div class="col-lg-12">
             ...
             <div class="row justify-content-end">
               <div class="form-group row" style="margin-right: 40px;">
                 ...
                 <Link :href="`/upload-dokumen-akreditasi/3jy4h6n8m3${data.id_detail_pengajuan}p0c13x/prodi`" class="btn btn-danger mr-2">
                   Kembali
                 </Link>
               </div>
             </div>
